...
def onMouse(event, x, y, flag, param):
    ...
    # 마우스 왼쪽 버튼이 떨어졌을 때
        ...
        print(length) # 픽셀 개수
        print("----length(cm)-------")
        print (length*pixel_per_cm)  # cm ( 픽셀 개수 * 센치미터당 픽셀 수)
        print("---------------------")
    return
...
distance = float(frontheight_points.front_foot.y - frontheight_points.front_head.y)
print(distance)
print("-----pixel per cm-----")
